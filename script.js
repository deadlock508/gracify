...
tag.src = "https://www.youtube.com/watch?v=N1BcpzPGlYQ";
...
function showMessage(response) {
  ...
  if (response === "Yes") {
    ...
    audioElement.src = "./celebration.mp3"; // Source of the sound
    ...
    yesMessage.textContent = "See you on the 14th my princess, grace";
